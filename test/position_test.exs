defmodule PositionTest do
  ...
  test "can create position" do
    assert %Position{} = Position.from_fen()
  end
  ...
  test "cannot translate ambiguous san" do
    ...
    # Sample message...
    # "Ambiguous san Nd2 to move"
    assert {:error, _message} = Position.san_to_move(p, "Nd2")
  ...
  test "can translate promotion" do
    ...
    # Message looks like...
    # "Could not transform move h7g8=p to san, ambigous search, found multipe moves"
    assert {:error, _message} = Position.move_to_san(p, "h7g8=p")
    assert {:error, _message} = Position.move_to_san(p, "h7g8=K")
  end
end
